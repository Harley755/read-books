            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center pb-4 bg-white dark:bg-gray-900">
                        ...
                        <div>
                            <a href="{{route('categories.create') }}" class="py-2 px-4 text-sm font-medium text-white bg-gray-800 rounded-l rounded-r  hover:bg-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Add new Category</a>
                        </div>
                                ...
                                @foreach ($categories as $category)   
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="py-4 px-20 flex items-center gap-x-1">
                                            <a href="{{ route('categories.edit', $category) }}" class="py-2 px-4 text-sm font-medium text-white bg-gray-800 rounded-l rounded-r  hover:bg-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Edit</a> 
